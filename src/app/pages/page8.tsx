    ...
    return (
        <div>
            ...
            <div style={{padding: "1rem"}} className="tabContent">
                ...
                <p>A genetic algorithm wont always produce a solution. If the algorithm gets stuck in a nearly right solution (one that has high fitness) but the actual solution is significantly different it will be unable to mutate out of its dead end.</p>
                ...
                <VisualGrid grid={graphicGrid} onGridChange={setGraphicGrid} geneticGraphic={true} graphicSpeed={2} />
                <nav className={"navButton"}>
                    {createLink(7, "Back")} | {createLink(9, "Forward")}
                </nav>
            </div>
        </div>
    );
